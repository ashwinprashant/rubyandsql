...
#apple = Company.where({"name" => "Apple"})[0] .... this also works, but is longer
#puts apple.inspect
...
#amazon["url"] = "http://amazon.com/" .....insert url for amazon even if we did not add it in the beginning / updating an existing value
#amazon.save
