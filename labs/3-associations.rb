...
puts "Activities between Ashwin and Tim:"

ashwin_and_tim_activities = Activity.where({"salesperson_id" => ashwin["id"], "contact_id" => tim["id"]})

for activity in ashwin_and_tim_activities
    puts "- #{activity["note"]}"
end
